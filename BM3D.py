...
# -*- coding: utf-8 -*-
"""
Created on Fri Jul 15 15:00:31 2022
...
Step1_max_matched_cnt = 4              # 组最大匹配的块数
...
if __name__ == '__main__':
    ...
    # files=['./image_dm3/normalization_5_atoms/5.24.10079.tif','./image_dm3/normalization_5_atoms/5.24.10080.tif','./image_dm3/normalization_5_atoms/5.24.10081.tif',\
    #        './image_dm3/normalization_5_atoms/5.24.10047.tif','./image_dm3/normalization_5_atoms/5.24.10048.tif','./image_dm3/normalization_5_atoms/5.24.10049.tif'
    #        ]
    
      # 图像的路径
    # files=['./image_dm3/normalization_5_atoms/5.24.10079.tif']
    # files=sorted(glob('./image_dm3/resize_average/*.tif'))
    files=['./image_dm3/normalization_6_atoms_type1/6.150152.tif']
    for img_name in tqdm(files):
        ...
        cv2.imwrite(f"./BM3D_result/first_step/{img_name.split('/')[-1]}.tif", Basic_img)
